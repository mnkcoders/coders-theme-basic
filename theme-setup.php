 ...
 * 
 */
final class CoderThemeBase extends CoderThemes {
    
    /**
     * 
     * @return \CoderThemes
     */
    protected final function registerThemeCustomizers() {
        return $this->element('top_bar',self::TYPE_TEXT, $this->mod('coders_top_bar_layout',''))
     ...
     * @return \CoderThemes
     */
    protected final function registerThemeSettings() {
        //theme custom settings
        return $this->customSetting('coders_theme_color', $this->themeColors())
     ...
     * @return \CoderThemes
     */
    protected final function registerThemeSupport() {
        //theme core elements
        return $this->themeSupport('post-thumbnails', array('post'))
                ->themeSupport('custom-logo', $this->logoSetup());
    }
    /**
     * @return \CoderThemes
     */
    protected final function registerThemeBlocks() {
        //theme customizer
        return $this->customSection('coders_theme_setup', array('title' => __('Coders Theme Setup', 'coder_themes'), 'priority' => 30))
     ...
     * @return \CoderThemes
     */
    protected final function registerThemeMenus() {
        return $this->menu('top', __('Top Menu', 'coder_themes'))
     ...
     * @return \CoderThemes
     */
    protected final function registerThemeSidebars() {
        return $this->sidebar('blog',__('Sidebar','coder_themes'))
     ...
     * @return \CoderThemes
     */
    protected final function registerThemeScripts() {
        return $this->style('google-fonts', 'https://fonts.googleapis.com/css2?family=Roboto:ital,wght@0,100;0,300;0,400;0,500;0,700;0,900;1,100;1,300;1,400;1,500;1,700;1,900&display=swap')
    ...
    protected final function themeWrappers(): array {
        return array(
            'top-bar','header-main','footer-widgets','bottom-bar'
        );
    }
    /**
     * @return array
